...
for account in config['accounts']:
	...
	total_chats = 0
	total_messages = 0
	if 'message_sessions' in sessions_dict:
		...
		for account_id in account_ids:
			...
			if recent_messages_req is not None: #Ocassionally it is none, not sure if this is because the request failed or if the chat is too old
